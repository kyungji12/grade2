...
public class HomeController {
	...
	public String allviewDB(Model model) {
		...
		try {
			model.addAttribute("list", service.selectAll());//서비스 호출하고 결과를 바로 모델에 넣어줌
